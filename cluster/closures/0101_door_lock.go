...
func (v *GetLogRecord) LogIndexString() string {
	return zcl.Sprintf("%s", zcl.Zu16(v.LogIndex))
}
...
func (v *OperationgEventNotification) String() string {
	...
	str = append(str, "UserId["+v.UserIdString()+"]")
	str = append(str, "Pin["+v.PinString()+"]")
	str = append(str, "ZigbeeLocalTime["+v.ZigbeeLocalTimeString()+"]")
...
func (v *GetLogRecordResponse) LogEntryIdString() string {
	return zcl.Sprintf("%s", zcl.Zu16(v.LogEntryId))
}
func (v *GetLogRecordResponse) TimestampString() string {
	return zcl.Sprintf("%s", zcl.Zu32(v.Timestamp))
}
...
func (v *GetLogRecordResponse) String() string {
	...
	str = append(str, "EventType["+v.EventTypeString()+"]")
	str = append(str, "Source["+v.SourceString()+"]")
	str = append(str, "EventIdAlarmCode["+v.EventIdAlarmCodeString()+"]")
	str = append(str, "UserId["+v.UserIdString()+"]")
	str = append(str, "Pin["+v.PinString()+"]")
