...
func (GetProfile) Name() string { return "Get Profile" }
...
func (RequestMirrorResponse) Name() string { return "Request Mirror Response" }
...
func (MirrorRemoved) Name() string { return "Mirror Removed" }
